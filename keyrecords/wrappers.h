...
#define ___________________APT_L1__________________       KC_W,    KC_G,    KC_D,    KC_F,    KC_B
#define ___________________APT_L2__________________       KC_R,    KC_S,    KC_T,    KC_H,    KC_K
#define ___________________APT_L3__________________       KC_X,    KC_C,    KC_M,    KC_P,    KC_V

#define ___________________APT_R1__________________       KC_Q,    KC_L,    KC_U,    KC_O,    KC_Y
#define ___________________APT_R2__________________       KC_J,    KC_N,    KC_E,    KC_A,    KC_I,    KC_QUOT
#define ___________________APT_R3__________________       KC_Z,    KC_COMM, KC_DOT,  KC_SCLN, KC_SLASH
...
// begin momentary wackyness
#define _________________KLINGON_L1________________   UC(0x211a), UC(0x2145), UC(0x211b), UC(0x20a9), UC(0x212c)
#define _________________KLINGON_L2________________   UC(0x212b), UC(0x20b7), UC(0x210d), UC(0x20b8), UC(0x2141)
#define _________________KLINGON_L3________________   KC_Z, KC_X, KC_M, UC(0x2102), KC_V
#define _________________KLINGON_R1________________   UC(0x2111), UC(0x2132), UC(0x2127), UC(0x2119), KC_SCLN
#define _________________KLINGON_R2________________   UC(0x213d), UC(0x2115), UC(0x2107), UC(0x2134), UC(0x2148), KC_QUOT
#define _________________KLINGON_R3________________   KC_K, UC(0x2143), KC_COMM, KC_DOT, KC_SLSH
// end momentary wackyness
...
#define _______NUMBER_L1_______       KC_7,    KC_8,    KC_9
#define _______NUMBER_L2_______       KC_4,    KC_5,    KC_6
#define _______NUMBER_L3_______       KC_1,    KC_2,    KC_3
#define _______NUMBER_L4_______       _______, KC_0,  _______
#define ________________NUMBER_LEFT_1______________       KC_1,    KC_2,    KC_3,    KC_4,    KC_5
#define ________________NUMBER_RIGHT_1_____________       KC_6,    KC_7,    KC_8,    KC_9,    KC_0
#define ________________NUMBER_LEFT________________       G(KC_1),    G(KC_2),    G(KC_3),    G(KC_4),    G(KC_5)
#define ________________NUMBER_RIGHT_______________       G(KC_6),    G(KC_7),    G(KC_8),    G(KC_9),    G(KC_0)
#define _________________FUNC_1____________________        KC_F1,    KC_F2,    KC_F3,    KC_F4, KC_F5
#define _________________FUNC_2____________________        KC_F6,    KC_F7,    KC_F8,    KC_F9, KC_F10
#define _________________FUNC_3____________________       KC_F11,   KC_F12,   KC_F13,   KC_F14, KC_F15
#define _________________FUNC_4____________________       KC_F16,   KC_F17,   KC_F18,   KC_F19, KC_F20
#define _______________LAYER_SHIFT_1_______________       KC_ASTG,   GAMING,   SYM_M,   SYM_L, VIMHELP
#define ______________LAYOUT_SHIFT_1_______________       KC_VOLU,   SYM_Q,   SYM_C,   SYM_D, _______
#define ________________AUTO_SHIFT_________________       KC_ASTG, KC_ASDN, KC_ASUP, KC_ASRP
#define ___________________BLANK___________________       _______, _______, _______, _______, _______
#define ___________________SYMBL___________________       _______, _______, _______, _______, _______
#define __________________VIM_3____________________       VIMQUIT, VIMWRIT,    KC_Y,    KC_P,    KC_D
#define _________________VIM_NAV___________________          KC_H,    KC_J,    KC_K,    KC_L, VIMINSE
#define _________________UNICODE_1_________________       UC(0x2554), UC(0x2557), UC(0x2550), UC(0x2560), UC(0x2563), _______
#define _________________UNICODE_2_________________       UC(0x255A), UC(0x255D), UC(0x2551), UC(0x2566), UC(0x2569), UC(0x256c)
#define _________________LOWER_L1__________________       KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC
#define _________________LOWER_L2__________________       _________________FUNC_LEFT_________________
#define _________________LOWER_L3__________________       _________________FUNC_RIGHT________________
#define ________________MOUSE_WHEEL________________       KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______
#define ________________I3WM_ADJUST________________       KC_PWS,  KC_NWS, OSM_PUP, OSM_PDN, SGUI(KC_Q)
#define _________________I3WM_MOVE_________________       G(KC_LEFT), G(KC_DOWN), G(KC_UP), G(KC_RGHT), G(KC_D)
#define _________________MOUSE_MOVE________________       KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______
