...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_TERMVI] = LAYOUT_redox_wrapper(
      _______, _______, _______, _______, _______, _______,                                             ________________NUMBER_RIGHT_1_____________, _______,
      _______, _______, C(KC_W),    KC_W, S(KC_4), _______, _______,                           _______, ________________NUMBER_LEFT_1______________, _______,
      _______, __________________VIM_3____________________, _______,                           _______, _________________VIM_NAV___________________,  OSM_LS,
